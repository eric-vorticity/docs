...
<Update label="December 28, 2024" description="v0.3.1">
  ## Feature Additions 
  ...
  ## API Updates
    - Added new endpoint for retreiving portfolio correlations.
</Update>


<Update label="December 14, 2024" description="v0.3.0">
  ## Feature Additions 
  ...
  ## API Updates
    - Added new endpoint for submitting margin calculations.
</Update>


<Update label="November 25, 2024" description="v0.2.1">
  ## Model Updates
