...
When using the Plutus API, you can include equities in your portfolio submission. Each equity position allows for the following customizable properties:

## Properties

- **Ticker**: The unique identifier of the equity position (e.g., `"AAPL"` for Apple Inc).
...
## Modeling Different Types of Equities

The Plutus API can model a wide range of equities, including those from different exchanges, sectors, and geographies. Here are some of the types of equities you can model in your portfolio:
